...
@section('content')
    ...
    <section id="view-settings" class="view ">
        <div class="card">
            ...
            <div class="card-body">
                <form id="settingsForm" class="row g-3" action="{{ route('admin.settings.update') }}" method="POST">
                    @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="site_name" placeholder="অনলাইন বাংলা নিউজ"
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="site_tagline" placeholder="সত্যের পথে, নির্ভীক সাংবাদিকতা"
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="og_default_title" placeholder="অনলাইন বাংলা নিউজ"
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="og_default_image" placeholder="/storage/og-default.jpg"
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="facebook_link" placeholder="https://facebook.com/yourpage"
                            value="{{ old('facebook_link', seo_setting('facebook_link')) }}">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">YouTube চ্যানেল লিংক</label>
                        <input class="form-control" name="youtube_link" placeholder="https://youtube.com/@yourchannel"
                            value="{{ old('youtube_link', seo_setting('youtube_link')) }}">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Twitter / X লিংক</label>
                        <input class="form-control" name="twitter_link" placeholder="https://x.com/username"
                            value="{{ old('twitter_link', seo_setting('twitter_link')) }}">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Instagram লিংক</label>
                        <input class="form-control" name="instagram_link" placeholder="https://instagram.com/username"
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="contact_email" placeholder="news@example.com"
                            value="{{ old('contact_email', seo_setting('contact_email')) }}">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">ফোন নম্বর</label>
                        <input class="form-control" name="contact_phone" placeholder="+8801XXXXXXXXX"
                            value="{{ old('contact_phone', seo_setting('contact_phone')) }}">
                    </div>

                    <div class="col-12">
                        <label class="form-label">অফিস ঠিকানা</label>
                        <textarea class="form-control" name="contact_address" rows="2" placeholder="হেড অফিসের ঠিকানা এখানে লিখুন">{{ old('contact_address', seo_setting('contact_address')) }}</textarea>
                    </div>
